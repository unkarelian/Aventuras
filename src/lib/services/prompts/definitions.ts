 ...
 * Macros are now defined in ./definitions/macros/.
 * Templates remain here until Plan 02 migrates them.
 */

import type { Macro, PromptTemplate } from './types';

// Import macros from the modular structure
import {
  BUILTIN_MACROS,
  CONTEXT_PLACEHOLDERS,
  getPlaceholderByToken,
} from './definitions/macros';

// Re-export macros for backward compatibility
export { BUILTIN_MACROS, CONTEXT_PLACEHOLDERS, getPlaceholderByToken };
